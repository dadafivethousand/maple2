...
export default function About() {
    const items = [
        { icon: "fas fa-map-marker-alt", text: "First Brazilian Jiujitsu Academy in Maple, Ontario" },
    ...
    return (
        <div id='About' className='AboutContainer'>
            <h1 className="animate"> <span className='White'> About </span> <span className='Crimson'> Maple Jiujitsu </span></h1>
            <p className="animate"> At Maple Jiu-Jitsu Academy, we are committed to delivering a top-tier training experience for all skill levels. Our passion for Brazilian Jiu-Jitsu goes beyond just techniques; it’s about building a strong, inclusive community where everyone can grow, learn, and thrive.</p>
