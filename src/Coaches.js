...
export default function Coaches() {
    return(
       ...
       <h1 > Coaches </h1>
       <p>Our team of coaches is committed to providing top-level BJJ instruction in a safe, inclusive, and professional environment. <span className="bold">Click on each photo to learn more.</span></p>
       </div>
