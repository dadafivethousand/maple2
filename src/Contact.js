...
export default function Contact() {
    return(
        ...
        <div className='ContactInfo-and-map'>
          <div className='Map'>
            <h1>Conveniently Located     In the Heart of <span className='Crimson'> Maple </span> </h1>
            <ul>
        ...
        <span id='ContactText' className='ContactText'> (647) 887-9940</span>
        </div>
        <div className='Email'>
