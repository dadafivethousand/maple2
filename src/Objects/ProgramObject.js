...
import mijain from '../Media/mijain.jpg'
...
const Programs = [
    ...
    {image: mijain ,name:'Greco-Roman Wrestling', description: 'Greco-Roman Wrestling focuses on upper-body control, throws, and dominant positioning. This class emphasizes mastering clinch techniques, powerful takedowns, and relentless mat pressure. These sessions develop strength, endurance, and technical precision to elevate your wrestling game.' },

    {image: freestyle,name:'Freestyle Wrestling', description: 'Freestyle Wrestling is a fast-paced and dynamic grappling style that allows attacks on both the upper and lower body. This class focuses on explosive takedowns, leg attacks, and fluid transitions to control and pin your opponent. ' },
    ...
    {image: kids,name:'Kids (ages 5-12)', description: 'Our Kids program is designed to build confidence, discipline, and coordination in a fun and supportive environment. We focus on teaching the fundamentals of BJJ while instilling important life values like respect, perseverance, and teamwork.'},
]
