...
const Programs = [
    ...
    {image: freestyle,name:'Wrestling', description: 'Wrestling is a fast-paced and dynamic grappling style that focuses on explosive takedowns, leg attacks, and fluid transitions to control and pin your opponent. ' },
